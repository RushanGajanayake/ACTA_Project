...
$query1 = $db->prepare('SELECT * FROM student WHERE Person_NIC = :u_nic');
            ...
            <form action='/ACTA_project/mod/parent/reprt.php' method="post" id="report_stu">
                <table class="table1">
                    <tr class="row1">
                        ...
                        <td class="input_data"><input class="input data" type="text" name="stu_Id" id="stu_Id" value="<?php echo$st_id; ?>" readonly="readonly" ></td>
                    </tr>
                    <tr>
                        <td></td>
