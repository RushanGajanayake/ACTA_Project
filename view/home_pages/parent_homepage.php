...
<!--                            <li><a href="#">Settings</a> </li>-->
                            <li><a href="#" onclick="myFunction1('/ACTA_project/view/parent/parent_details.php')">Profile</a> </li>
...
<!--                    <li class="selected"> <a href="#"> NAVIGATION </a> </li>-->
                    <li></li>
                    <li class="icon "> <a href="#" onclick="myFunction1('/ACTA_project/view/parent/par_home.php')"> <img class="pic" src="/ACTA_project/res/image/home1.png"  height="70" width="70"  onmouseover="this.src='/ACTA_project/res/image/home2.png';" onmouseout="this.src='/ACTA_project/res/image/home1.png';"></a> </li>
                    <li class="icon "> <a href="#" onclick="myFunction1('/ACTA_project/view/parent/parent_details.php')"> <img class="pic" src="/ACTA_project/res/image/persnal_details1.png"  height="70" width="70" onmouseover="this.src='/ACTA_project/res/image/persnal_details2.png';" onmouseout="this.src='/ACTA_project/res/image/persnal_details1.png';"> </a> </li>
                    <li class="icon "> <a href="#" onclick="myFunction1('/ACTA_project/view/parent/get_report.php')"> <img class="pic" src="/ACTA_project/res/image/repoerts1.png"  height="70" width="70" onmouseover="this.src='/ACTA_project/res/image/repoerts2.png';" onmouseout="this.src='/ACTA_project/res/image/repoerts1.png';"> </a> </li>
                    <li class="icon "> <a href="#" onclick="myFunction1('/ACTA_project/view/parent/par_payment.php')"> <img class="pic" src="/ACTA_project/res/image/payments1.png"  height="70" width="70" onmouseover="this.src='/ACTA_project/res/image/payments2.png';" onmouseout="this.src='/ACTA_project/res/image/payments1.png';"> </a> </li>
