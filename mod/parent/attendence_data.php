...
class ParentAttenReport{
    ...
    public function __construct(){
        ...
        if(isset($_POST['generateRep'])){
            ...
            $this->getData($username,$month1,$year1,$month2,$year2);
    ...
    public  function getData($username,$month1,$year1,$month2,$year2){
